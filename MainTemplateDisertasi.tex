...
\begin{document}
	...
	\include{Lembar_Penguji}
	\include{originalitas}% menggabungkan file lembar pengesahan
	\include{abstrak}% menggabungkan file abstraksi
	\include{abstract}
	...
	\input{bab1/Bab1_Pendahuluan.tex} %Bab 1
	\input{bab2/Bab2_TinjauanPustaka.tex} %Bab 2
	\input{bab3/Bab3_Metodologi.tex} %Bab 3
	\input{bab4/Bab4_HasilDiskusi.tex} %Bab 4
