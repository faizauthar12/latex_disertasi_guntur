...
%
% Bila anda melakukan perubahan pada file ini, tolong ubah nama file-nya agar
% bisa berbeda dengan file yang telah ada ini.
%
...
%% Universitas Gunadarma Kampus D Gedung 1 Lt.1
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Bentuk pemenggalan lebih baik digunakan menggunakan parameter berikut:
%
 \lefthyphenmin=2
 \righthyphenmin=2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
2t1k 2t1l 2t1n 2t1t
2w1t                 % Dua kelompok konsonan yang akan dipenggal dari
                     % konsonan yang lain
2ng1g 2ng1h 2ng1k 2ng1n 2ng1s    % Tiga kelompok konsonan
2n3s2t % kon-stan-ta
.be2r3 .te2r3 .me2ng3 .pe2r3 % prefiks
...
%% untuk beberapa kata, khususnya yang dimulai dengan awalan ber- dan ter-
